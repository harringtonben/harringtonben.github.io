...
# Create a main.js file and link to it in your blog.html
# Create an html element with the id ‘blog-holder’
# Make an array called blogs
# Add each of your existing blogs to the blogs array by making them into objects with the following key, value pairs: title, content, date (you should have at least 5 blog objects)
